...
body > .container > .row:first-of-type {
  ...
  grid-template-columns: minmax(240px, 270px) minmax(400px, 1.2fr) minmax(240px, .8fr);
...
span[style*="background-color:white"] {
  ...
  border: 0;
  border-radius: 2px;
  box-shadow: inset 0 0 0 1px rgba(102,192,244,.28), inset 0 0 10px rgba(102,192,244,.06);
  line-height: inherit;
